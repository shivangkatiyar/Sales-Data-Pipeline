...
######################## Get S3 client ####################################
aws_access_key = encrypt(config.aws_access_key)

#aws_access_key = ""
aws_secret_key = encrypt(config.aws_secret_key)
...
# Else give an error and not process the file
...
# Check the required column in the schema of required csv files
# If not required columns keep it in a list of error_files
...
#Move the error data to error directory on local
...
logger.info("****************** Final data from sales team data mart *************************")
...
logger.info("************* Deleted customer data mart local file *************")

logger.info("***************** Deleting sales_team_data_mart_local_file from local ************")
delete_local_file(config.sales_team_data_mart_local_file)
logger.info("************* Deleted sales team data mart local file *************")


logger.info("***************** Deleting sales_team_data_mart_partitioned_local_file from local ************")
delete_local_file(config.sales_team_data_mart_partitioned_local_file)
logger.info("************* Deleted sales team data mart partitioned local file *************")
